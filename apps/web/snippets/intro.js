...
window.INTRO_TEXT = {
  ...
  `,
  batch: `
      <p>This page is where you set up your batch settings. It stores the information the generator uses when creating text.</p>
      <ul>
        <li>Personal details</li>
        <li>Specific catergories</li>
        <li>Interests or focus areas</li>
      ...
      <p>Once saved, the batch settings can be reused for any future text or written output without typing everything again.</p>
  `
};
